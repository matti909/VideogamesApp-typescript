...
let Platform = (_dec = (0, _typeorm.Entity)({
  name: 'platforms'
}), _dec2 = (0, _typeorm.PrimaryGeneratedColumn)(), _dec3 = (0, _typeorm.Column)({
  name: 'name',
  type: 'varchar'
}), _dec4 = (0, _typeorm.ManyToMany)(() => _games.Games, game => game.platforms), _dec5 = (0, _typeorm.JoinTable)(), _dec(_class = (_class2 = class Platform extends _base.BaseEntity {
  constructor(...args) {
    super(...args);
