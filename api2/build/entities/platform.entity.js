...
let PlatformEntity = (_dec = (0, _typeorm.Entity)({
  name: 'platforms'
}), _dec2 = (0, _typeorm.PrimaryGeneratedColumn)(), _dec3 = (0, _typeorm.ManyToMany)(() => _games.Games, game => game.platforms), _dec4 = (0, _typeorm.JoinTable)(), _dec(_class = (_class2 = class PlatformEntity extends _base.BaseEntity {
  constructor(...args) {
    super(...args);
